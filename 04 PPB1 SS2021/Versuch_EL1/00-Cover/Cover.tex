...
\def\uberschrift{Protokoll EL1} % Absatz mit \\[0,5cm]; u = Übung, k = Klausur; s = Skript, e = Ergebnis
\def\bottom{SS2021}
\def\datum{26. März 2021}
\def\platz{NWII | 2.1.01.470}
\def\betreuer{Michael Buchhorn}
\def\auswertp{Charlotte Geiger}
\def\messp{Manuel Lippert}
\def\protop{Leonard Schatt}
\def\groupnr{4}
