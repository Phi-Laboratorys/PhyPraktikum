...
\begin{center}
    \includegraphics[width = 8cm]{diffOPVverbessert.PNG}
...
\begin{center}
    \includegraphics[width = 7cm]{Bilder/43-diffSchwingung.jpg}
    \captionof{figure}{$U_a$ eines \textbf{einfachen} Umkehrdifferenzierers beim Anlegen einer Dreiecksspannung mit der Frequenz $f$ = 1kHz}
...
\begin{center}
    ...
    \captionof{figure}{$U_a$ eines \textbf{verbesserten} Umkehrdifferenzierers beim Anlegen einer Dreiecksspannung mit der Frequenz $f$ = 1kHz}
    \label{Einschwingprozess}
\end{center}
...
\subsection*{Zusammenhang zwischen dem Frequenzgang des Umkehrintegrators und dem des Umkehrdifferenzierers}
