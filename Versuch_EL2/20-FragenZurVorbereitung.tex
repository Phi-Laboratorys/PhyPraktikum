...
Das \textbf{Verstärkung–Bandbreite–Produkt} bleibt dabei näherungsweise konstant $v\cdot B = v \cdot f_{gr} = \text{constant}$. Der konstante Bereich wird dabei durch die Grenzfrequenz $f_{gr}$ begrenzt, wobei bei einer Verstärkung $v=0$ die sogenannte \textbf{Transitfrequenz} $f_T$ liegt. \footnote[1]{Eichler, Kronfeldt, Sahm - Das neue Physikalische Praktikum, Kapitel 31}
\newpage
...
\label{sec:begriffe}
\begin{itemize}
    \item \textbf{Eingangs-Offsetstrom} (Input Offset Current):\\ Eingangsstromdifferenz bei der die Ausgangsspannung des Operationsverstärkers 0 V beträgt. \footnotemark[2]
...
\end{itemize}
\footnotetext[2]{Hering, Bressler, Gutekunst - Elektronik für Ingenieure und Naturwissenschaftler, Kapitel 8.2 - 8.4}
\footnotetext[3]{Wikipedia- Operationsverstärker}
