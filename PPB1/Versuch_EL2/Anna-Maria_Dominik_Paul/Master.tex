...
\newcommand{\Versuchstitel}{Versuch El2} 
\newcommand{\Versuchsuntertitel}{Der Operationsverstärker}
\newcommand{\Versuchsdatum}{05.05.2021}
\newcommand{\Semester}{Sommersemester 2021}
\newcommand{\Betreuer}{Christoph Schnupfhagn}
\newcommand{\Bild}{titel}

\newcommand{\Gruppennummer}{6}
\newcommand{\Auswerteperson}{Dominik Müller}
\newcommand{\Mesperson}{Paul Schwanitz}
\newcommand{\Protokollperson}{Anna-Maria Pleyer}
...
\input{FragenZurVorbereitung.tex}
