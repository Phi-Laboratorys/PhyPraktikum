...
\begin{figure}[ht]
    ...
    \includegraphics[scale=0.7]{63-Linear.png}
\end{figure}
...
\begin{center}
    ...
    \begin{tabular}{c c}
        \includegraphics[scale=0.5]{63-Histw4.png} & \includegraphics[scale=0.5]{63-Hist.png}
    \end{tabular}
\end{center}
...
\begin{center}
    ...
    \includegraphics[scale=0.6]{63-Praezession.png}
\end{center}
\newpage
\begin{center}
    \captionof{figure}{$w_3$-$w_*$ Diagramm mit Messreihe 4}
    \includegraphics[scale=0.6]{63-Praezessionw4.png}
\end{center}
