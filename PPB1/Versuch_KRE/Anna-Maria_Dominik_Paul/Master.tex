...
\newcommand{\Versuchstitel}{Versuch Kre} 
\newcommand{\Versuchsuntertitel}{Der Kreisel}
\newcommand{\Versuchsdatum}{22.03.2021}
\newcommand{\Semester}{Sommersemester 2021}
\newcommand{\Betreuer}{Michael Beckstein}
\newcommand{\Bild}{titel}

\newcommand{\Gruppennummer}{6}
\newcommand{\Auswerteperson}{Dominik Müller}
\newcommand{\Mesperson}{Anna-Maria Pleyer}
\newcommand{\Protokollperson}{Paul Schwanitz}
