...
\def\farbe{Notagrey}
\def\fach{PPBphys1}
\def\name{Charlotte Geiger - Manuel Lippert - Leonhard Schatt}
\def\uberschrift{Polarisation} % Absatz mit \\[0,5cm]; u = Übung, k = Klausur; s = Skript, e = Ergebnis
\def\bottom{SS2021}
\def\datum{19.05.2021}
\def\platz{NWII | 2.1.02.669}
\def\betreuer{Moritz Heindl}
\def\auswertp{Charlotte Geiger}
\def\messp{Manuel Lippert}
\def\protop{Leonhard Schatt}
\def\groupnr{4}
