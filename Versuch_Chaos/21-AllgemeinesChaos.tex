...
Systeme die das Verhalten des deterministischen Chaos zeigen weisen ein zufällig erscheinendes Verhalten auf, was jedoch nicht durch äußere Umstände verursacht wird. Sondern das Verhalten folgt aus den Eigenschaften des Systems selbst.\\
Das Verhalten von System mit deterministischem Chaos lässt sich langfristig nicht vorhersagen, da ähnliche Uhrsachen langfristig nicht zu ähnlichen Wirkungen führen. Dieser Effekt ist unter dem Namen Schmetterlingseffekt bekannt \citep[vgl.][]{WikiDetChaos}.
...
\end{gather}
Das Leistungsspektrum stellt die Leistungsanteile für unterschiedliche Frequenzen im Zeitsignal da.\\

Bei chaotischen Systemen beispielsweiße erhält man ein Leistungsspektrum mit kontinuierlichem Verlauf, das für große Frequenzen abnimmt \citep[vgl.][]{Lueck}. Warum kein hinreichender Beweis??? 
% TODO #28 @PaulSchwanitz
