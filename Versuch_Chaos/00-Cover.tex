...
\def\uberschrift{Chaos} % Absatz mit \\[0,5cm]; u = Übung, k = Klausur; s = Skript, e = Ergebnis
\def\bottom{WS2021/22}
\def\datum{Datum}
\def\platz{NWII | RaumNr.}
\def\betreuer{Betreuer}

\def\teilnehmer{Manuel Lippert, Paul Schwanitz}
...
\begin{tabular}{l l}
	...
	{\textbf{Teilnehmer}} \hspace{1cm} & \hspace{1cm} {\teilnehmer}\\[0.2cm]
