...
\begin{itemize}
    ...
    \begin{center}
        \includegraphics[scale=0.3]{Resonanzkurve.png}
        \captionof{figure}{Resonanzkurven für eines Duffing-Oszillator}
...
\begin{center}
    \includegraphics[scale=0.25]{AufbauPendel.png}
    \captionof{figure}{Aufbau des invertierten Pendels}
...
\begin{center}
    \includegraphics[scale=0.3]{MessschaltungPendel.png}
    \captionof{figure}{Messschaltung des invertierten Pendels}
