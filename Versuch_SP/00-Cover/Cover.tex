...
\def\uberschrift{Protokoll SP} % Absatz mit \\[0,5cm]; u = Übung, k = Klausur; s = Skript, e = Ergebnis
\def\bottom{SS2021}
\def\datum{24. März 2021}
\def\platz{NWII | 2.1.02.671}
\def\betreuer{Uwe Gerken}
\def\auswertp{Leonard Schatt}
\def\messp{Charlotte Geiger}
\def\protop{Manuel Lippert}
\def\groupnr{4}
