...
\def\uberschrift{Protokoll KRE} % Absatz mit \\[0,5cm]; u = Übung, k = Klausur; s = Skript, e = Ergebnis
\def\bottom{SS2021}
\def\datum{22. M\"arz 2021}
\def\betreuer{Michael Beckstein}
...
\begin{titlepage}
	...
	% Betreuer tec.
	\vspace{8cm}
	{\large\sffamily Datum: \datum\par}
	{\large\sffamily Betreuer: \betreuer\par}
