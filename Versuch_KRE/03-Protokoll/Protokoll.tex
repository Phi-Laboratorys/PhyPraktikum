...
\begin{center}
    \begin{tabular}{c c}
        \includegraphics[scale=0.21]{6.3_Screenshots/6.3_Messung1.jpg} \hspace{0.5cm} & \hspace{0.5cm} \includegraphics[scale=0.21]{6.3_Screenshots/6.3_Messung2.jpg}\\[0.5cm]            
        \includegraphics[scale=0.21]{6.3_Screenshots/6.3_Messung3.jpg} \hspace{0.5cm} & \hspace{0.5cm} \includegraphics[scale=0.21]{6.3_Screenshots/6.3_Messung4.jpg}            
    \end{tabular}
